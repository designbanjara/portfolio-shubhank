...
const CraftDocsFloat = () => {
  ...
  return <div className="fixed top-4 left-60 z-50 bg-card border border-border rounded-lg shadow-lg max-w-xs">
      <div className="flex items-start justify-between p-3 px-[8px] py-[4px]">
        ...
        <button onClick={() => setIsVisible(false)} className="flex-shrink-0 p-1 hover:bg-muted rounded transition-colors" aria-label="Dismiss">
