        ...
        <div className="space-y-8 mt-8">
          ...
          <article className="border-b border-[#333] pb-6">
            <a href="#" className="block group hover:bg-[#1f1f1f] p-4 -m-4 rounded-lg transition-colors">
              <div className="flex gap-4">
                <img 
                  src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=80&h=80&fit=crop&crop=center" 
                  alt="Design Systems That Scale"
                  className="w-20 h-20 rounded-lg object-cover flex-shrink-0"
                />
                <div className="flex-1 min-w-0">
          ...
          <article className="border-b border-[#333] pb-6">
            <a href="#" className="block group hover:bg-[#1f1f1f] p-4 -m-4 rounded-lg transition-colors">
              <div className="flex gap-4">
                <img 
                  src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=80&h=80&fit=crop&crop=center" 
                  alt="The Future of Web Interaction"
                  className="w-20 h-20 rounded-lg object-cover flex-shrink-0"
                />
                <div className="flex-1 min-w-0">
                  <h2 className="mb-1 text-white group-hover:text-gray-100 font-bold text-lg">
