...
const blogPosts: BlogPost[] = [
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <h1 className="text-4xl font-bold mb-4">Typography Guide: Making Your Content Shine</h1>
        ...
        <h2 className="text-3xl font-bold mt-8 mb-4">Paragraphs</h2>
        ...
        <h2 className="text-3xl font-bold mt-8 mb-4">Text Formatting</h2>
        ...
        <h2 className="text-3xl font-bold mt-8 mb-4">Lists</h2>
        <p className="mb-4">Lists help organize information in scannable chunks:</p>
        
        <h3 className="text-2xl font-bold mb-2">Unordered List</h3>
        ...
        <h3 className="text-2xl font-bold mb-2">Ordered List</h3>
        ...
        <h2 className="text-3xl font-bold mt-8 mb-4">Blockquotes</h2>
        ...
        <h2 className="text-3xl font-bold mt-8 mb-4">Images with Captions</h2>
